...
<div class="row">
    <div class="container">
        ...
        <div id="originalCarousel" class="carousel slide" data-ride="carousel">
            ...
            <a class="carousel-control-next" href="#originalCarousel" role of a button" data-slide="next">
                    ...
                    @foreach ($chunk as $product)
                        <div class="col-lg-4 col-sm-4">
                            <div class="box_main">
                                ...
                                <div class="btn_main">
                                    <form class="buy-form" method="POST" action="{{ route('panier.addProduct') }}">
                                        @csrf
                                        <input type="hidden" name="product_id" value="{{ $product->id }}">
                                        <input type="number" name="quantity" value="1"> <!-- You can modify the quantity as needed -->
