                ...
                <div class="col-sm-8">
                    <div class="top_1l clearfix">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                <a class="m_tag" href="#" data-toggle="dropdown" role="button"
                                    aria-expanded="false">Usd<span class="caret"></span></a>
                                <ul class="dropdown-menu drop_1" role="menu">
                                    <li><a href="#">Eur</a></li>
                                    <li><a class="border_none" href="#">Usd</a></li>
                                </ul>
                            </li>
                            <li><a class="m_tag border_none" href="{{ route('products.index') }}"><i
                                        class="fa fa-bookmark-o"></i> Produit</a></li>
                            <li><a class="m_tag" href="{{ route('artist-requests') }}"><i class="fa fa-phone"></i>
                                    Request</a></li>
                ...
                <div class="col-sm-4">
                    <div class="top_1l clearfix">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                <a class="m_tag border_none" href="#" data-toggle="dropdown" role="button"
                                        ...
                                        <div class="drop_1i1 clearfix">
                                            <div class="col-sm-8">
                                                <div class="drop_1i1l clearfix">
                                                    <h6 class="mgt bold"><a href="#">Nulla Quis</a> <br> <span
                                                            class="normal col_2">1x - $89.00</span> <br> <span><i
                                                                class="fa fa-remove"></i></span></h6>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="drop_1i1r text-right clearfix"><a href="#"><img
                                                            src="img/1.jpg" class="iw" alt="abc"></a></div>
                                            </div>
                                        </div>
                                        <div class="drop_1i1 clearfix">
                                            <div class="col-sm-8">
                                                <div class="drop_1i1l clearfix">
                                                    <h6 class="mgt bold"><a href="#">Eget Nulla</a> <br> <span
                                                            class="normal col_2">1x - $49.00</span> <br> <span><i
                                                                class="fa fa-remove"></i></span></h6>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="drop_1i1r text-right clearfix"><a href="#"><img
                                                            src="img/2.jpg" class="iw" alt="abc"></a></div>
                                            </div>
                                        </div>
